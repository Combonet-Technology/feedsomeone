...
BREVO_VACANCY_ACK_TEMPLATE_ID = os.environ.get(
    'BREVO_VACANCY_ACK_TEMPLATE_ID'
)
BREVO_VACANCY_ACK_TEMPLATE_ID = (
    int(BREVO_VACANCY_ACK_TEMPLATE_ID)
...
SLACK_VACANCIES_WEBHOOK_URL = os.environ.get('SLACK_VACANCIES_WEBHOOK_URL')
